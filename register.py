...
def register_user():     
    ...
    if not username or not email or not password:
        messagebox.showerror("Σφαλμα","όλα τα πεδία είναι υποχρεωτικά.")
        return 
    ...
    try:
        ...
        if cursor.fetchone():
            messagebox.showwarning("Σφάλμα","To email υπάρχει ήδη.")
            return
...
tk.Button(root,text="Εγγραφή",command=register_user).grid(row=3,column=0,columnspan=2,pady=20)
